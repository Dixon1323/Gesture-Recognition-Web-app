...
def speak(text_received):
    tts = gTTS(text=text_received, lang=language, slow=False)
    audio_bytes_io = BytesIO()
    tts.write_to_fp(audio_bytes_io)
    audio_bytes_io.seek(0)  # Reset the pointer to the beginning of the BytesIO object
